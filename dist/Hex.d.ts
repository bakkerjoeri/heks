...
export interface ComponentFilter {
    [componentName: string]: boolean | ComponentPrimitive | ((value: Component, entity: Entity, engine: Hex) => boolean);
}
export interface Constructable<TClass> {
    new (...args: any[]): TClass;
}
export declare type EventHandler = (engine: Hex, ...args: any[]) => void;
export declare type EventHandlerPerEntity<TComponents extends Components = {}> = (engine: Hex, entity: Entity<TComponents>, ...args: any[]) => void;
export declare type EventHandlerForEntityGroup<TComponents extends Components = {}> = (engine: Hex, entities: (Entity<TComponents>)[], ...args: any[]) => void;
