...
const _hoisted_1 = { class: "Debugger" };
const _hoisted_2 = { class: "Debugger__header" };
const _hoisted_3 = { class: "FpsMeter" };
const _hoisted_4 = { class: "Controls" };
const _hoisted_5 = /*#__PURE__*/createVNode("option", { value: 1 }, "1x", -1 /* HOISTED */);
const _hoisted_6 = { class: "Debugger__sidebar StateInspector" };
const _hoisted_7 = {
  ref: "gameContainer",
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_value_inspector = resolveComponent("value-inspector");

  return (openBlock(), createBlock("div", _hoisted_1, [
    createVNode("header", _hoisted_2, [
      createVNode("div", _hoisted_3, toDisplayString($options.fps) + " FPS ", 1 /* TEXT */),
      createVNode("div", _hoisted_4, [
        ...
        ($options.isRunning)
          ? (openBlock(), createBlock("button", {
              key: 1,
              onClick: _cache[2] || (_cache[2] = (...args) => (_ctx.$stopGame && _ctx.$stopGame(...args)))
            }, " Pause "))
          : createCommentVNode("v-if", true),
        (!$options.isRunning)
          ? (openBlock(), createBlock("button", {
              key: 2,
              onClick: _cache[3] || (_cache[3] = (...args) => (_ctx.$tickGame && _ctx.$tickGame(...args)))
            }, " Tick "))
          : createCommentVNode("v-if", true),
        (!$options.isRunning)
          ? withDirectives((openBlock(), createBlock("input", {
              ...
              step: "1",
              min: "0",
              max: $data.stateHistory.length - 1,
              "onUpdate:modelValue": _cache[4] || (_cache[4] = $event => ($data.stateHistoryIndex = $event)),
              onInput: _cache[5] || (_cache[5] = (...args) => ($options.handleChangeStateHistory && $options.handleChangeStateHistory(...args)))
            }, null, 40 /* PROPS, HYDRATE_EVENTS */, ["max"])), [
              [
                vModelText,
                $data.stateHistoryIndex,
                void 0,
                { number: true }
              ]
            ])
          : createCommentVNode("v-if", true),
        (!$data.isReplaying && !$options.isRunning)
          ? (openBlock(), createBlock("button", {
              key: 4,
              onClick: _cache[6] || (_cache[6] = $event => ($data.isReplaying = true)),
              disabled: $data.stateHistoryIndex === $data.stateHistory.length - 1
            }, " Replay ", 8 /* PROPS */, ["disabled"]))
          : createCommentVNode("v-if", true),
        ($data.isReplaying)
          ? (openBlock(), createBlock("button", {
              key: 5,
              onClick: _cache[7] || (_cache[7] = $event => ($data.isReplaying = false))
            }, " Pause replay "))
          : createCommentVNode("v-if", true),
        (!$options.isRunning)
          ? withDirectives((openBlock(), createBlock("select", {
              key: 6,
              "onUpdate:modelValue": _cache[8] || (_cache[8] = $event => ($data.replaySpeed = $event)),
              disabled: $data.isReplaying
            }, [
              createVNode("option", { value: 0.05 }, "0.05x", 8 /* PROPS */, ["value"]),
              createVNode("option", { value: 0.1 }, "0.1x", 8 /* PROPS */, ["value"]),
              createVNode("option", { value: 0.25 }, "0.25x", 8 /* PROPS */, ["value"]),
              createVNode("option", { value: 0.5 }, "0.5x", 8 /* PROPS */, ["value"]),
              createVNode("option", { value: 0.75 }, "0.75x", 8 /* PROPS */, ["value"]),
              _hoisted_5
            ], 8 /* PROPS */, ["disabled"])), [
              [vModelSelect, $data.replaySpeed]
            ])
          : createCommentVNode("v-if", true)
      ])
    ]),
    createVNode("aside", _hoisted_6, [
      createVNode(_component_value_inspector, { value: $options.state }, null, 8 /* PROPS */, ["value"])
    ]),
    createVNode("main", _hoisted_7, null, 512 /* NEED_PATCH */)
  ]))
}

script.render = render;
script.__file = "src/debugger/Debugger.vue";
...
script$1.__file = "src/debugger/icons/angle-down.vue";
...
script$2.__file = "src/debugger/icons/angle-right.vue";
...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_angle_right = resolveComponent("angle-right");
  const _component_angle_down = resolveComponent("angle-down");
  const _component_value_inspector = resolveComponent("value-inspector");

  return (openBlock(), createBlock("div", {
    class: ["PropertyInspector", { 'PropertyInspector--collapsible': $options.canCollapse }]
  }, [
    createVNode("span", {
      class: "PropertyInspector__name",
      title: $props.path.join('.'),
      onClick: _cache[1] || (_cache[1] = (...args) => ($options.handleToggleCollapse && $options.handleToggleCollapse(...args)))
    }, [
      ($options.canCollapse && $data.isCollapsed)
        ? (openBlock(), createBlock(_component_angle_right, {
            key: 0,
            class: "PropertyInspector__icon"
          }))
        : createCommentVNode("v-if", true),
      ($options.canCollapse && !$data.isCollapsed)
        ? (openBlock(), createBlock(_component_angle_down, {
            key: 1,
            class: "PropertyInspector__icon"
          }))
        : createCommentVNode("v-if", true),
    ...
    createVNode(_component_value_inspector, {
      depth: $props.depth,
      "is-collapsed": $data.isCollapsed,
      value: $props.value,
      path: $props.path
    }, null, 8 /* PROPS */, ["depth", "is-collapsed", "value", "path"])
  ], 2 /* CLASS */))
}

script$3.render = render$3;
script$3.__file = "src/debugger/components/PropertyInspector.vue";
...
function render$4(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_property_inspector = resolveComponent("property-inspector");
  const _component__self = resolveComponent("_self");

  return (openBlock(), createBlock(KeepAlive, null, [
    ($options.isValueObject)
      ? (openBlock(), createBlock("ul", {
          key: 0,
          class: ["ValueInspector", {'is-collapsed': $props.isCollapsed}]
        }, [
          (openBlock(true), createBlock(Fragment, null, renderList(Object.entries($props.value), ([name, childValue], index) => {
            return (openBlock(), createBlock("li", {
              key: index,
              class: "ValueInspector__child"
            }, [
              createVNode(_component_property_inspector, {
                depth: $props.depth + 1,
                name: name,
                path: [...$props.path, name],
                value: childValue
              }, null, 8 /* PROPS */, ["depth", "name", "path", "value"])
            ]))
          }), 128 /* KEYED_FRAGMENT */))
        ], 2 /* CLASS */))
      : ($options.isValueArray)
        ? (openBlock(), createBlock("ul", {
            key: 1,
            class: ["ValueInspector", {'is-collapsed': $props.isCollapsed}]
          }, [
            (openBlock(true), createBlock(Fragment, null, renderList($props.value, (childValue, index) => {
              return (openBlock(), createBlock("li", {
                key: index,
                class: "ValueInspector__child"
              }, [
                createVNode(_component__self, {
                  depth: $props.depth + 1,
                  value: childValue
                }, null, 8 /* PROPS */, ["depth", "value"])
              ]))
            }), 128 /* KEYED_FRAGMENT */))
          ], 2 /* CLASS */))
        : (openBlock(), createBlock("div", _hoisted_1$3, [
            createVNode("input", {
              class: "ValueInspector__value",
              value: $props.value
            }, null, 8 /* PROPS */, ["value"])
          ]))
  ], 1024 /* DYNAMIC_SLOTS */))
...
script$4.__file = "src/debugger/components/ValueInspector.vue";
...
script$5.__file = "src/debugger/icons/Icon.vue";

function setupDebugger(game) {
    var _a;
    const heksData = ref({
    ...
    const debuggerApp = createApp(script, {
        isRunning: heksData.value.isRunning,
    });
    debuggerApp.component('value-inspector', script$4);
    debuggerApp.component('property-inspector', script$3);
    debuggerApp.component('icon', script$5);
    ...
    debuggerApp.config.globalProperties.$updateState = (state, time) => {
        game.state = state;
        game.loop.time = time;
        heksData.value.state = Object.assign({}, state);
    ...
    (_a = game.canvas.parentElement) === null || _a === void 0 ? void 0 : _a.appendChild(debuggerContainer);
...
export { EventEmitter, Game, Loop, calculateNewFrameIndex, clearCanvas, createSpriteComponent, doesEntityMatch, drawSprite, entityState, findEntities, findEntity, getEntities, getEntity, getImageForFilePath, getSprite, isPointInPoint, isPointInRectangle, isRectangleInRectangle, setComponent, setEntities, setEntity, setSprite, setSprites, setupCanvas, setupDebugger, setupKeyboardEvents, setupMouseEvents, setupUpdateAndDrawEvents, spriteState, updateAnimatedSprites };
